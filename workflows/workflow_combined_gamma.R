##Function that performs the entire workflow for the weather only and two step calibration process with gamma for power distributions
...
workflow_combined_gamma <- function(ensemble_name,
                              control_name,
                              obs_name,
                              power_name,
                              file_path,
